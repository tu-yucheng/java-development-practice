...
class FunctionalEndpointValidationsLiveTest {
    ...
    void whenRequestingAnnotatedEPWithInvalidBody_thenObtainBadRequest() {
        AnnotatedRequestEntity body = new AnnotatedRequestEntity("user", "passwordLongThan7digits");
    ...
    @Test
    void whenRequestDryEPWithValidBody_thenObtainOkRequest() {
    ...
    @Test
    void whenRequestingComplexEPWithValidBody_thenObtainOkRequest() {
        CustomRequestEntity body = new CustomRequestEntity("name", "1234567");
    ...
    @Test
    void whenRequestingAnnotatedEPWithValidBody_thenObtainOkRequest () {
