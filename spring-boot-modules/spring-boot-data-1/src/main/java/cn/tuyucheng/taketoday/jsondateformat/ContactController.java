...
public class ContactController {
    ...
    public List<Contact> getContacts() {
        ...
        Contact contact1 = new Contact("John Doe 1", "123 Sesame Street", "123-456-789", LocalDate.now(), LocalDateTime.now());
    ...
    public List<ContactWithJavaUtilDate> getContactsWithJavaUtilDate() {
        ...
        ContactWithJavaUtilDate contact1 = new ContactWithJavaUtilDate("John Doe 1", "123 Sesame Street", "123-456-789", new Date(), new Date());
    ...
    public List<PlainContact> getPlainContacts() {
        ...
        PlainContact contact1 = new PlainContact("John Doe 1", "123 Sesame Street", "123-456-789", LocalDate.now(), LocalDateTime.now());
    ...
    public List<PlainContactWithJavaUtilDate> getPlainContactsWithJavaUtilDate() {
        ...
        PlainContactWithJavaUtilDate contact1 = new PlainContactWithJavaUtilDate("John Doe 1", "123 Sesame Street", "123-456-789", new Date(), new Date());
