...
class ResponseHeaderLiveTest {
    ...
    private static final String SERVICE_SINGLE_RESPONSE_HEADER = "Tuyucheng-Example-Header";
    private static final String SERVICE_FILTER_RESPONSE_HEADER = "Tuyucheng-Example-Filter-Header";
    ...
    @Test
    void whenUsingResponseEntityBuilderRequest_thenObtainResponseWithCorrectHeaders() {
        client = WebTestClient.bindToServer()
                .baseUrl(BASE_URL)
                .build();
    ...
    @Test
    void whenUsingServerHttpResponseRequest_thenObtainResponseWithCorrectHeaders() {
        ResponseSpec response = client.get()
    ...
    @Test
    void whenUsingFunctionalHandlerRequest_thenObtainResponseWithCorrectHeaders() {
        ResponseSpec response = client.get()
