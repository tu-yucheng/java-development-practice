...
public class DataBufferToInputStream {
    ...
    public static InputStream getResponseAsInputStream(WebClient client, String url) throws IOException {
        ...
        Flux<DataBuffer> body = client.get()
                ...
                .doOnError(error -> logger.error("error occurred while reading body", error))
                ...
                .doOnCancel(() -> logger.error("Get request is cancelled"));
